            ...
            return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return Nova.request().get("/nova-vendor/nova-app-preview/");

                        case 2:
                            this.config = _context.sent.data;
          ...
          _vm.config
            ? _c("div", { staticClass: "phone-frame-wrap" }, [
                _c("div", {
                  ...
                  style: { backgroundColor: _vm.config.color }
                }),
                _vm._v(" "),
                _c("iframe", { attrs: { src: _vm.config.appUrl } })
              ])
            : _vm._e()
        ]
      )
